...
Shader "Skybox"
{
	Properties
	{
		[KeywordEnum( Lerp,Add )] _CloudBlend( "Cloud Blend", Float ) = 0
		...
		_CloudSmoothness( "Cloud Smoothness", Range( 0, 1 ) ) = 0.15
		_BendExponent( "Bend Exponent", Range( 1, 50 ) ) = 8
		[Header(Cloud Horizon)] _CloudHorizonHeight( "Cloud Horizon Height", Range( 0, 1 ) ) = 0.2
		...
		[Header(Cloud Edge)] _EdgeCutoff( "Edge Cutoff", Range( 0, 1 ) ) = 0.45
		...
		_InteriorTransmission( "Interior Transmission", Range( 0, 1 ) ) = 0.5
		...
		_GroundSmoothness( "Ground Smoothness", Range( 0, 1 ) ) = 0.1
	...
	LOD 0
		...
		Pass
		{
			...
			CGPROGRAM
				...
				#pragma shader_feature_local _CLOUDBLEND_LERP _CLOUDBLEND_ADD
				...
				float4 FBMWithGradient( float2 UV, int Octaves, float Gain, float Lacunarity, float2 DistortionDirection, float DistortionAmount, float DistortionExponent )
				{
					return fbmd(UV,Gain,Lacunarity,Octaves,DistortionDirection,DistortionAmount,DistortionExponent);
				}
				...
				) : SV_Target
				{
					...
					float3 temp_output_1089_0 = lerpResult112_g1112;
					...
					float2 DistortionDirection16_g474 = appendResult25_g474;
					float DistortionAmount16_g474 = ( _DistortionSpeed * _Time.y );
					float DistortionExponent16_g474 =  (0.001 + ( _DistortionScale - 1.0 ) * ( 2.0 - 0.001 ) / ( 0.0 - 1.0 ) );
					float4 localFBMWithGradient16_g474 = FBMWithGradient( UV16_g474 , Octaves16_g474 , Gain16_g474 , Lacunarity16_g474 , DistortionDirection16_g474 , DistortionAmount16_g474 , DistortionExponent16_g474 );
					float temp_output_14_0_g474 = (localFBMWithGradient16_g474).x;
					float temp_output_586_39_g468 = temp_output_14_0_g474;
					float smoothstepResult12_g470 = smoothstep( temp_output_2_0_g470 , min( ( temp_output_2_0_g470 + _InteriorSmoothness ), 1.0 ) , temp_output_586_39_g468);
					float temp_output_1124_516 = smoothstepResult12_g470;
					float3 lerpResult966 = lerp( _BaseColour.rgb , _InteriorColour.rgb , ( _InteriorColour.a * temp_output_1124_516 ));
					...
					float3 temp_output_586_0_g468 = (localFBMWithGradient16_g474).yzw;
					float dotResult434_g468 = dot( normalizeResult440_g468 , temp_output_586_0_g468 );
					float temp_output_2_0_g469 = _EdgeCutoff;
					float smoothstepResult12_g469 = smoothstep( temp_output_2_0_g469 , min( ( temp_output_2_0_g469 + _EdgeSmoothness ), 1.0 ) , temp_output_586_39_g468);
					...
					float dotResult529_g468 = dot( normalizeResult526_g468 , temp_output_586_0_g468 );
					float temp_output_1124_525 = saturate( max( saturate( pow( temp_output_520_0_g468 , ( _TransmissionExponent * 2.0 ) ) ), ( pow( temp_output_520_0_g468 , _TransmissionExponent ) * dotResult529_g468 ) ) );
					float lerpResult1024 = lerp( ( ( 1.0 - temp_output_1124_516 ) * temp_output_1124_525 ) , temp_output_1124_525 , _InteriorTransmission);
					...
					float temp_output_1124_401 = ( saturate( smoothstepResult12_g475 ) * ( 1.0 - smoothstepResult12_g471 ) );
					float3 lerpResult828 = lerp( temp_output_1089_0 , lerpResult1026 , ( _BaseColour.a * temp_output_1124_401 ));
					#if defined( _CLOUDBLEND_LERP )
					float3 staticSwitch1130 = lerpResult828;
					#elif defined( _CLOUDBLEND_ADD )
					float3 staticSwitch1130 = ( temp_output_1089_0 + ( _BaseColour.a * temp_output_1124_401 * lerpResult1026 ) );
					#else
					float3 staticSwitch1130 = lerpResult828;
					#endif
					float smoothstepResult1048 = smoothstep( ( 1.0 - _GroundSmoothness ) , 1.0 , ( 1.0 - -ase_viewDirWS.y ));
					float3 lerpResult1038 = lerp( staticSwitch1130 , _GroundColour.rgb , ( _GroundColour.a * smoothstepResult1048 ));
...
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":1124,"pos":[3608,8],"params":["Inherit","False","Skybox Clouds","5","","468","e35217d2a61917344908c1fffe4ec998","0","2","38","FLOAT3","0,0,0","False","39","FLOAT3","0,0,0","False","4","FLOAT","525","FLOAT","515","FLOAT","516","FLOAT","401"]}
...
{"type":"AmplifyShaderEditor.ColorNode, AmplifyShaderEditor","id":963,"pos":[4792,-64],"params":["Inherit","False","Property","_InteriorColour","Interior Colour","2","0","Create","True","0","0","0","False","0","False","Object","-1","","0.1019608,0.09411765,0.2627451,0.4117647","0.1016985,0.09593832,0.2641475,0.4117647","True","True","0","6","COLOR","0","FLOAT","1","FLOAT","2","FLOAT","3","FLOAT","4","FLOAT3","5"]}
{"type":"AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor","id":1014,"pos":[3992,696],"params":["Inherit","False","Property","_InteriorTransmission","Interior Transmission","25","0","Create","True","0","0","0","False","0","False","Object","-1","","0.5","0.5","0","1","0","1","FLOAT","0"]}
{"type":"AmplifyShaderEditor.ColorNode, AmplifyShaderEditor","id":964,"pos":[4664,-320],"params":["Inherit","False","Property","_BaseColour","Base Colour","1","1","[Header]","Create","True","1","Cloud Colours","0","0","False","0","False","Object","-1","","0.3882353,0.4509804,0.4901961,1","0.3882319,0.4508415,0.490196,1","True","True","0","6","COLOR","0","FLOAT","1","FLOAT","2","FLOAT","3","FLOAT","4","FLOAT3","5"]}
...
{"type":"AmplifyShaderEditor.ColorNode, AmplifyShaderEditor","id":967,"pos":[4848,288],"params":["Inherit","False","Property","_EdgeColour","Edge Colour","3","1","[HDR]","Create","True","0","0","0","False","0","False","Object","-1","","11.31371,0.9649343,0,1","11.31371,0.9649343,0,1","True","True","0","6","COLOR","0","FLOAT","1","FLOAT","2","FLOAT","3","FLOAT","4","FLOAT3","5"]}
...
{"type":"AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor","id":1049,"pos":[3528,-264],"params":["Inherit","False","Property","_GroundSmoothness","Ground Smoothness","36","0","Create","True","1","Ground","0","0","False","0","False","Object","-1","","0.1","0.1","0","1","0","1","FLOAT","0"]}
...
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":1089,"pos":[3624,-536],"params":["Inherit","False","Skybox Colour","26","","1112","0c3f98426aec4244b83898e14f7900cd","0","2","98","FLOAT3","0,0,0","False","68","FLOAT3","0,0,0","False","1","FLOAT3","0"]}
{"type":"AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor","id":1128,"pos":[5328,-168],"params":["Inherit","False","3","3","0","FLOAT","0","False","1","FLOAT","0","False","2","FLOAT3","0,0,0","False","1","FLOAT3","0"]}
{"type":"AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor","id":970,"pos":[5104,-232],"params":["Inherit","False","2","2","0","FLOAT","0","False","1","FLOAT","0","False","1","FLOAT","0"]}
...
{"type":"AmplifyShaderEditor.SimpleAddOpNode, AmplifyShaderEditor","id":1127,"pos":[5504,-248],"params":["Inherit","False","2","2","0","FLOAT3","0,0,0","False","1","FLOAT3","0,0,0","False","1","FLOAT3","0"]}
{"type":"AmplifyShaderEditor.LerpOp, AmplifyShaderEditor","id":828,"pos":[5616,-384],"params":["Inherit","False","3","0","FLOAT3","0,0,0","False","1","FLOAT3","0,0,0","False","2","FLOAT","0","False","1","FLOAT3","0"]}
...
{"type":"AmplifyShaderEditor.ColorNode, AmplifyShaderEditor","id":1039,"pos":[5256,-656],"params":["Inherit","False","Property","_GroundColour","Ground Colour","35","1","[Header]","Create","True","1","Ground","0","0","False","0","False","Object","-1","","0.2352941,0.3098039,0.3568628,1","0.2350475,0.309113,0.3584901,1","True","True","0","6","COLOR","0","FLOAT","1","FLOAT","2","FLOAT","3","FLOAT","4","FLOAT3","5"]}
{"type":"AmplifyShaderEditor.StaticSwitch, AmplifyShaderEditor","id":1130,"pos":[5808,-392],"params":["Inherit","False","Property","_CloudBlend","Cloud Blend","0","0","Create","True","0","0","0","False","0","False","","0","0","0","True","","KeywordEnum","2","Lerp","Add","Create","True","True","All","9","1","FLOAT3","0,0,0","False","0","FLOAT3","0,0,0","False","2","FLOAT3","0,0,0","False","3","FLOAT3","0,0,0","False","4","FLOAT3","0,0,0","False","5","FLOAT3","0,0,0","False","6","FLOAT3","0,0,0","False","7","FLOAT3","0,0,0","False","8","FLOAT3","0,0,0","False","1","FLOAT3","0"]}
...
{"type":"AmplifyShaderEditor.LerpOp, AmplifyShaderEditor","id":1038,"pos":[6088,-512],"params":["Inherit","False","3","0","FLOAT3","0,0,0","False","1","FLOAT3","0,0,0","False","2","FLOAT","0","False","1","FLOAT3","0"]}
...
{"type":"AmplifyShaderEditor.TemplateMultiPassMasterNode, AmplifyShaderEditor","id":422,"pos":[6272,-528],"params":["Float","False","True","-1","3","AmplifyShaderEditor.MaterialInspector","0","7","Skybox","0770190933193b94aaa3065e307002fa","True","Unlit","0","1","Unlit","8","False","True","0","1","False","","0","False","","0","1","False","","0","False","","True","0","False","","0","False","","False","False","False","False","False","False","False","False","False","True","0","False","","False","True","0","False","","False","True","True","True","True","True","0","False","","False","False","False","False","False","False","False","True","False","0","False","","255","False","","255","False","","0","False","","0","False","","0","False","","0","False","","0","False","","0","False","","0","False","","0","False","","True","True","2","False","","False","False","False","True","1","RenderType=Opaque=RenderType","True","3","True","14","all","0","False","True","1","1","False","","0","False","","1","1","False","","0","False","","True","1","False","","1","False","","False","False","False","False","False","False","False","False","False","False","False","True","0","False","","False","True","True","True","True","True","0","False","","False","False","False","False","False","False","False","True","False","0","False","","255","False","","255","False","","0","False","","0","False","","0","False","","0","False","","0","False","","0","False","","0","False","","0","False","","True","True","2","False","","True","3","False","","True","True","0","False","","0","False","","False","True","1","LightMode=ForwardBase","False","False","0","","0","0","Standard","10","Surface","0","0","  Keep Alpha","0","0","  Blend","0","0","Alpha Clipping","0","0","  Use Shadow Threshold","0","0","Cast Shadows","0","639221269626662456","Write Depth","0","0","  Conservative","0","0","Extra Pre Pass","0","0","Vertex Position","1","0","0","3","False","True","False","False","","False","0"]}
{"wire":[1022,0,1124,516]}
{"wire":[1124,38,529,0]}
{"wire":[1124,39,528,0]}
{"wire":[962,0,963,4]}
{"wire":[962,1,1124,516]}
{"wire":[1016,0,1022,0]}
{"wire":[1016,1,1124,525]}
{"wire":[966,0,964,5]}
{"wire":[966,1,963,5]}
{"wire":[966,2,962,0]}
{"wire":[969,0,967,4]}
...
{"wire":[422,0,1038,0]}
ASEEND*/
//CHKSM=CB6ACA2B698018720CE51E10EB23FF100EBFD8CB