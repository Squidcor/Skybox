...
Shader "Skybox New"
{
	Properties
	{
		...
		_SunnyCloudColour( "Sunny Cloud Colour", Color ) = ( 0, 0, 0, 0 )
	...
	LOD 0
		...
		Pass
		{
			...
			CGPROGRAM
				...
				uniform float4 _SunnyCloudColour;
				...
				uniform float _GradientEdgeSmoothness;
				...
				) : SV_Target
				{
					...
					float3 temp_output_1_0_g442 = float3( 0,0,0 );
					float3 temp_output_4_0_g442 = float3( 0,1,0 );
					#if ( SHADER_TARGET >= 50 )
					float recip425_g438 = rcp( _CloudScale );
					#else
					float recip425_g438 = 1.0 / _CloudScale;
					#endif
					float3 appendResult457_g438 = (float3(0.0 , recip425_g438 , 0.0));
					float dotResult5_g442 = dot( temp_output_4_0_g442 , ( appendResult457_g438 - temp_output_1_0_g442 ) );
					float3 temp_output_39_0_g438 = ase_mainLightDirection;
					float3 temp_output_2_0_g442 = temp_output_39_0_g438;
					float dotResult8_g442 = dot( temp_output_4_0_g442 , temp_output_2_0_g442 );
					float3 temp_output_1_0_g439 = float3( 0,0,0 );
					float3 temp_output_4_0_g439 = float3( 0,1,0 );
					float dotResult5_g439 = dot( temp_output_4_0_g439 , ( appendResult457_g438 - temp_output_1_0_g439 ) );
					float3 temp_output_38_0_g438 = ase_viewDirWS;
					float3 temp_output_2_0_g439 = temp_output_38_0_g438;
					float dotResult8_g439 = dot( temp_output_4_0_g439 , temp_output_2_0_g439 );
					float3 temp_output_458_0_g438 = ( ( temp_output_1_0_g442 + ( ( dotResult5_g442 / dotResult8_g442 ) * temp_output_2_0_g442 ) ) - ( temp_output_1_0_g439 + ( ( dotResult5_g439 / dotResult8_g439 ) * temp_output_2_0_g439 ) ) );
					float3 normalizeResult459_g438 = normalize( temp_output_458_0_g438 );
					float3 break461_g438 = normalizeResult459_g438;
					float3 appendResult436_g438 = (float3(break461_g438.x , break461_g438.z , _Z));
					float3 normalizeResult440_g438 = normalize( appendResult436_g438 );
					float temp_output_27_0_g443 = radians( _ScrollDirection );
					float2 appendResult25_g443 = (float2(cos( temp_output_27_0_g443 ) , sin( temp_output_27_0_g443 )));
					float3 temp_output_1_0_g446 = float3( 0,0,0 );
					float3 temp_output_4_0_g446 = float3( 0,1,0 );
					#if ( SHADER_TARGET >= 50 )
					float recip24_g443 = rcp( _CloudScale );
					#else
					float recip24_g443 = 1.0 / _CloudScale;
					#endif
					float3 appendResult13_g445 = (float3(0.0 , recip24_g443 , 0.0));
					float dotResult5_g446 = dot( temp_output_4_0_g446 , ( appendResult13_g445 - temp_output_1_0_g446 ) );
					float3 temp_output_34_0_g443 = temp_output_38_0_g438;
					float3 temp_output_2_0_g446 = -temp_output_34_0_g443;
					float dotResult8_g446 = dot( temp_output_4_0_g446 , temp_output_2_0_g446 );
					float3 break14_g445 = ( temp_output_1_0_g446 + ( ( dotResult5_g446 / dotResult8_g446 ) * temp_output_2_0_g446 ) );
					float2 appendResult20_g445 = (float2(break14_g445.x , break14_g445.z));
					float2 lerpResult28_g445 = lerp( appendResult20_g445 , float2( 0,0 ) , pow( ( 1.0 - -temp_output_34_0_g443.y ) , _BendExponent ));
					float2 panner31_g443 = ( 0.1 * _Time.y * ( appendResult25_g443 * _ScrollSpeed ) + lerpResult28_g445);
					float2 UV16_g443 = panner31_g443;
					int Octaves16_g443 = _Octaves;
					float Gain16_g443 = 0.5;
					float Lacunarity16_g443 = 2.0;
					float GradientStrength16_g443 = _GradientStrength;
					float4 localFBMWithGradient16_g443 = FBMWithGradient( UV16_g443 , Octaves16_g443 , Gain16_g443 , Lacunarity16_g443 , GradientStrength16_g443 );
					float temp_output_2_0_g444 = _Cutoff;
					float smoothstepResult12_g444 = smoothstep( temp_output_2_0_g444 , min( ( temp_output_2_0_g444 + _Smoothness ), 1.0 ) , (localFBMWithGradient16_g443).x);
					float temp_output_4_0_g443 = saturate( smoothstepResult12_g444 );
					float smoothstepResult5_g443 = smoothstep( 0.0 , _GradientEdgeSmoothness , temp_output_4_0_g443);
					float3 lerpResult6_g443 = lerp( float3( 0,0,1 ) , (localFBMWithGradient16_g443).yzw , smoothstepResult5_g443);
					float3 temp_output_470_0_g438 = lerpResult6_g443;
					float dotResult434_g438 = dot( normalizeResult440_g438 , temp_output_470_0_g438 );
					float temp_output_442_0_g438 = saturate( dotResult434_g438 );
					float3 lerpResult388_g438 = lerp( _CloudColour.rgb , _SunnyCloudColour.rgb , temp_output_442_0_g438);
					float3 lerpResult828 = lerp( lerpResult29_g1180 , lerpResult388_g438 , temp_output_4_0_g443);
...
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":746,"pos":[4424,-512],"params":["Inherit","False","SkyboxColour","18","","1180","0c3f98426aec4244b83898e14f7900cd","0","2","98","FLOAT3","0,0,0","False","68","FLOAT3","0,0,0","False","1","FLOAT3","0"]}
{"type":"AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor","id":920,"pos":[4400,-80],"params":["Inherit","False","SkyboxCloudColour","0","","438","e35217d2a61917344908c1fffe4ec998","0","2","38","FLOAT3","0,0,0","False","39","FLOAT3","0,0,0","False","2","FLOAT","401","FLOAT3","0"]}
...
{"wire":[422,0,828,0]}
ASEEND*/
//CHKSM=71E3A5FA2CBE9A7FFE2C82AB6F58C9F4236F4A8D